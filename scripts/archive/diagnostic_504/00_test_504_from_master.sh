#!/usr/bin/env bash
# Script à exécuter depuis install-01
# Se connecte sur un master K3s pour exécuter les tests

set +e

echo "=============================================================="
echo " [KeyBuzz] Test Final 504 depuis Master K3s"
echo "=============================================================="
echo ""

# Se connecter sur master-01 (qui a kubectl)
MASTER_IP="10.0.0.100"

echo "Connexion sur k3s-master-01 ($MASTER_IP)..."
echo ""

# Exécuter les tests depuis le master
...
# Test 3: Ingress -> Service via Host header
